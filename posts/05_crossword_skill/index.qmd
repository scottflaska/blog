...
date: "2025-04-27"
draft: false
categories: [bayesian, state space, stan, r]
...
In this post, I'll outline a model that could be used to evaluate crossword player performance (borrowing heavily from [this excellent post](https://richjand.rbind.io/post/2021/08/23/state-space-season-simulations/) by Richard Anderson)
